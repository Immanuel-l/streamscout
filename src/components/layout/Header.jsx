        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
                ...
                className={({ isActive }) =>
                  `px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                    isActive
                      ...
                      : 'text-surface-200 hover:text-surface-100 hover:bg-surface-700/70'
                  }`
                }
              >
                {label}
          ...
          <div className="flex items-center gap-1 md:hidden">
            ...
            <button
              ...
              className="text-surface-200 hover:text-surface-100 p-2 rounded-lg hover:bg-surface-700/70 transition-colors"
