...
function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-surface-950/80 backdrop-blur-md pt-[env(safe-area-inset-top)] border-b border-accent-500/10" style={{ boxShadow: '0 1px 20px -4px rgba(245, 158, 11, 0.08)' }}>
      ...
      <nav
        className={`md:hidden absolute top-full left-0 w-full border-b border-surface-800/60 bg-surface-950/80 backdrop-blur-xl overflow-hidden transition-all duration-300 ease-out shadow-2xl ${
